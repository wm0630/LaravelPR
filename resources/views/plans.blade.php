...
<body class="hero-anime">
                ...
                <div class="col-12">
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <a class="navbar-brand" href="/"><img
                                style="width: 200px !important; height: auto !important;" src="/images/logo.png"
                                alt=""></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto py-4 py-md-0">
                                ...
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                                    <a class="nav-link">Plans and Pricing</a>
                                </li>
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
            ...
            <div class="col-xl-4 col-md-4 col-xs-12">
                <div class="card">
                    <div class="card-header center">
                        <h4>Premium</h4>
                        <h1><sup>$</sup> 75</h1>
                        <a href="" style="background: #f4b242;" class="btn btn-primary" style="width: 80%"
                            id="premium" onclick="package(this)">Select Premium</a>
                    </div>
                    <div class="card-body">
                        <ul>
            ...
            <div class="col-xl-4 col-md-4 col-xs-12">
                <div class="card">
                    <div class="card-header center">
                        ...
                        <h1><sup>$</sup> 130</h1>
                        <a href="" style="background: #f4b242;" class="btn btn-primary" style="width: 80%"
                            id="premium" onclick="package(this)">Select Multi-Room</a>
                    </div>
                    <div class="card-body">
                        <ul>
            ...
            <div class="col-xl-4 col-md-4 col-xs-12">
                <div class="card">
                    <div class="card-header center">
                        ...
                        <a href="" style="background: #f4b242;" class="btn btn-primary" style="width: 80%"
                            id="premium" onclick="package(this)">Select Customized</a>
                    </div>
                    <div class="card-body">
                        <ul>
        ...
        <form method="post" action="#upload" enctype="multipart/form-data" id="myform">
            <div class="row">
                <div class="col-xl-6 col-md-6 col-xs-12">
                    ...
                    <textarea id="roomdimension" class="form-control" style="height: 100px"></textarea>
                    <p>Other Requirements</p>
                    <textarea id="otherrequirements" class="form-control" style="height: 100px"></textarea>
                </div>
                <div class="col-xl-6 col-md-6 col-xs-12">
                    <p>Room Picture/Layout</p>
                    <input type="file" id="roompic" accept="image/*">
    ...
    <script type="text/javascript">
        ...
        function package(element) {
            ...
            if (id === "premium") {
                ...
                localStorage.setItem("startamount", "75");
            } else if (id === "multi-room") {
                localStorage.setItem("Max", "2");
                localStorage.setItem("Selected", "0");
                localStorage.setItem("startamount", "130");
            }
            if (id === "customized") {
                localStorage.setItem("Max", "2");
                localStorage.setItem("Selected", "0");
                localStorage.setItem("startamount", "500");
            }
            obj = {
                userid: sessionid,
                package: id,
                amount: localStorage.getItem("startamount")
            }
            $.ajax({
                type: "GET",
                url: "apis/update.php",
        ...
        function room(element) {
            var Max = parseFloat(localStorage.getItem("Max"));
            var Selected = parseFloat(localStorage.getItem("Selected"));
            if (Selected >= Max) {
                alert("Sorry you can only choose maximum of " + Max + " design(s)");
                localStorage.setItem("res", "no");
                return false;
            } else if (Selected < Max) {
                localStorage.setItem("res", "yes");
                if (Selected == 0) {
                    var Selected = parseFloat(localStorage.getItem("Selected")) + parseFloat(1);
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            //alert("Success");
                            $("#loading").fadeOut(300);
                            var getPackage = localStorage.getItem("package");
            ...
            if (files.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        obj = {
                            userid: sessionid,
                            roomdimension: document.getElementById("roomdimension").value,
                ...
                $("#paynow").fadeIn(300);
                $("#stepNine").fadeOut(300);
                document.getElementById("attachPack").innerText = localStorage.getItem("package");
                document.getElementById("attachAmount").innerText = localStorage.getItem("startamount");
                paypal.Buttons({
                    createOrder: function(data, actions) {
                        ...
                        return actions.order.create({
                            purchase_units: [{
                                amount: {
                                    value: localStorage.getItem("startamount")
                                }
                            }]
                        });
                    },
                    onApprove: function(data, actions) {
                        ...
                        return actions.order.capture().then(function(details) {
                            ...
                            var getPack = localStorage.getItem("package");
    ...
    <div style="top: 0; right: 0; position: fixed; z-index: 99999999999" id="google_translate_element"></div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div
                        ...
                        <input class="form-control" placeholder="Enter Coupon code"><br /><br />
                        <button class="btn btn-danger" onclick="getCoupon()">Validate</button>
                    </div>
                </div>
            </div>
        </div>
